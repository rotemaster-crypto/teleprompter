...
- **แตะจอ** = พัก/เล่น • **ลากขึ้น/ลง** = กรอไปข้างหน้า/ถอยหลังมาอ่านใหม่ • **แถบล่าง** = ปรับความเร็ว/ขนาด/กระจก
- **โหมดกระจก** = สลับซ้าย-ขวาของ **ภาพกล้อง** (ตัวหนังสืออ่านปกติเสมอ ไม่กลับด้าน)
- เปิด toggle **อัดวิดีโอ** → **อัดอัตโนมัติทันทีที่นับถอยหลังจบ** (หรือกดปุ่มแดงมุมซ้ายบนเริ่ม/หยุดเองก็ได้)
- อัดเสร็จ → หน้าพรีวิว → **บันทึกลง Photos** → เลือก **Save Video**
- วิดีโอที่อัดเป็น **ภาพจากกล้องล้วน ไม่มีตัวหนังสือติดไปด้วย**

### ตัดสคริปต์ยาวเป็น "ชุด" อัตโนมัติ

- เปิด toggle **ตัดเป็นชุดอัตโนมัติ** → แอปจะแบ่งสคริปต์ยาว ๆ ให้เป็นชุดสั้น ๆ เอง ไม่ต้องมานั่งตัดเอง
- ปรับ **ความยาว/ชุด** ได้ (ยิ่งมากยิ่งได้ชุดยาว) — หัวมุมขวาบนจะบอกจำนวนชุด เช่น `120 คำ · 6 ชุด`
- ในหน้าอ่านมีแถบ **‹ 2/6 ›** กลางบน กดเลื่อนไปชุดถัดไป/ก่อนหน้า (คีย์บอร์ด: ลูกศร ซ้าย/ขวา)
- เหมาะกับการ **อัดทีละชุด**: อ่าน+อัดชุดหนึ่ง → เซฟ → กด › ไปชุดถัดไป
- วิธีตัด: แบ่งตาม **บรรทัดว่าง/บรรทัด** ก่อน ถ้ายังยาวเกินจะตัดตามความยาว (นับเป็น **ตัวอักษร** จึงรองรับภาษาไทยที่ไม่เว้นวรรค)
